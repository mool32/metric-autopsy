...
| `main.pdf` | compiled preview — **13 pages, 2 figures** | **no** — arXiv builds the PDF from source |
...
3. **Upload** `arxiv-submission.tar.gz`. arXiv detects LaTeX and compiles with pdfLaTeX. Wait for
   ...
   (title page, abstract, 2 figures, ~13 pages). The source is pure-ASCII standard LaTeX, so it
   compiles under arXiv's pdfLaTeX without extra steps.
...
### Comments
```
13 pages, 2 figures. Software (MIT): https://github.com/mool32/metric-autopsy ; archived at Zenodo https://doi.org/10.5281/zenodo.21195679
```
